...
export default function MaterialsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Detail Modal */}
      {selectedMaterial && (
        <div className="fixed inset-0 bg-black/20 bg-opacity-50 z-50 flex items-center justify-center p-4" onClick={() => setSelectedMaterial(null)}>
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">{selectedMaterial.nama}</h3>
                  {selectedMaterial.bahanUpahAlatBantu && selectedMaterial.bahanUpahAlatBantu !== selectedMaterial.nama && (
                    <p className="text-sm text-gray-600">{selectedMaterial.bahanUpahAlatBantu}</p>
                  )}
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">Kode</div>
                    <div className="font-mono font-medium text-gray-900">{selectedMaterial.kode}</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">Kode AHS</div>
                    <div className="font-mono font-medium text-gray-900">{selectedMaterial.kodeAhs}</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">No</div>
                    <div className="font-medium text-gray-900">{selectedMaterial.no}</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">Kelompok</div>
                    <div className="font-medium text-gray-900">{selectedMaterial.kelompok}</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">Satuan</div>
                    <div className="font-medium text-gray-900">{selectedMaterial.satuan}</div>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 mb-1">Koefisien</div>
                    <div className="font-medium text-gray-900">{selectedMaterial.koefisien}</div>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Harga Satuan</div>
                    ...
                    <div>
                      <div className="text-sm text-gray-500 mb-1">Jumlah Harga</div>
